...
enemyHide = [0]*4
speed = 1
backgroundWorld = GameImage("view/background/backgroundMundo.png")
playerHouse = GameImage("view/Sprites/map/casa1.png")
girlTent = GameImage("view/Sprites/map/tendaItemPorLevel2.png")
testYourLuckGirl = Sprite("view/Sprites/map/testYourLuckGirl.png")
noneHouse = GameImage("view/Sprites/map/casa2.png")
houseInFire1 = GameImage("view/Sprites/map/casa3PegandoFogo.png")
houseInFire2 = GameImage("view/Sprites/map/casa4PegandoFogo.png")
fire1 = GameImage("view/Sprites/map/fogo.png")
fire2 = GameImage("view/Sprites/map/fogo.png")
fire3 = GameImage("view/Sprites/map/fogo.png")
fire4 = GameImage("view/Sprites/map/fogo.png")
fire5 = GameImage("view/Sprites/map/fogo.png")
fire6 = GameImage("view/Sprites/map/fogo.png")
iSeeDeadPeople = GameImage("view/Sprites/map/mortoMapa.png")
howOftenDoYouSeeThem = GameImage("view/Sprites/map/mortoMapa.png")
allTheTime = GameImage("view/Sprites/map/cachorroMorto.png")
trapWeapon = GameImage("view/Sprites/map/armaTrap.png")
tree = Sprite("view/Sprites/map/arvore.png")
halfTree = Sprite("view/Sprites/map/arvoreMetade.png")
river = Sprite("view/Sprites/map/rio.png")
fence = Sprite("view/Sprites/map/tocoCerca.png")
burnedTree = Sprite("view/Sprites/map/arvoreQueimada.png")
halfBurnedTree = Sprite("view/Sprites/map/arvoreQueimadaMetade.png")
item = [5, 10, 15, 20]
item1 = Sprite("view/Sprites/map/item2.png")
item2 = Sprite("view/Sprites/map/item2.png")
item3 = Sprite("view/Sprites/map/item2.png")
item0 = Sprite("view/Sprites/map/item2.png")

weapon = [99, 2, 3, 4]
weapon1 = Sprite("view/Sprites/map/arma1.png")
weapon2 = Sprite("view/Sprites/map/arma1.png")
weapon3 = Sprite("view/Sprites/map/arma1.png")
# Best weapon
weapon0 = Sprite("view/Sprites/map/weapon4.png")

enemy = Sprite("view/Sprites/map/enemy.png")
enemy1 = Sprite("view/Sprites/map/enemy.png")
enemy2 = Sprite("view/Sprites/map/enemy.png")
enemy3 = Sprite("view/Sprites/map/enemy.png")

boss1 = Sprite("view/Sprites/map/boss1.png")
boss2 = Sprite("view/Sprites/map/boss2.png")
boss3 = Sprite("view/Sprites/map/boss3.png")
boss4 = Sprite("view/Sprites/map/boss4.png")

textBackground = Sprite("view/Sprites/map/backgroundText.png")
global tradeText
...
def drawMessages(player, screenWorld):
    ...
    if player.text:
        ...
        textBackground.draw()
        arrayText = initialText("view/data_base/text/testYourLuck/trade.txt")
